    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-foreground">NexusKeys Admin</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="••••••••••••"
              autoFocus
              className="w-full h-11 px-4 rounded-lg border border-input text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-background"
            />
          </div>
          {error && (
          ...
          <Button type="submit" className="w-full h-11 font-semibold" disabled={loading || !password.trim()}>
